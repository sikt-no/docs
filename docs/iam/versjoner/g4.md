...
|G4.9*   |AppRoles usage(Delvis implementert)   |- Bruken av tilgangsobjekter i idautoPersonAppRoles7 har blitt utvidet til å inkludere rettigheter/systemroller   |-   |
|G4.10  |Engagements |- Endringene er gjort i actionset ‘DBToIdentityStore’ og ‘FnAssignBusinessEngagementRoles’  |-   |
